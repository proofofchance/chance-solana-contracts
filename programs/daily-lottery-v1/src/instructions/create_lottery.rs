...
pub fn process(program_id: &Pubkey, accounts: &[AccountInfo]) -> ProgramResult {
    process_scheduled(program_id, accounts, None)
}
...
pub fn process_scheduled(
    ...
    lottery.freeze_config(&config)?;
    lottery.created_at_unix = current_time;
